...
close all;
%cover image 
cover_image=imread('elephant1.jpg');
figure(1);
subplot(2,2,1);
...
%secret image
secret_image=imread('elephant.jpg');
subplot(2,2,2);
...
imwrite(uint8(rgb2),'Extracted.jpg');title('Extracted Secret Image');


pic1=double(secret_image);
